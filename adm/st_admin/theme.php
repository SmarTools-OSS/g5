...
<div class="local_desc01 local_desc">
    <p><strong>주의!</strong> 순정 테마설정 기능을 포함 및 현재 적용된 ST 테마의 <strong>추가적인 옵션기능</strong>을 제공하므로 이곳에서 테마설정을 수행하시길 권장합니다.</p>
</div>
...
<?php
// ST 테마의 확장설정 UI 로드
$adm_file = G5_THEME_PATH.'/theme.adm.php';
if( file_exists($adm_file) ) {
	echo '<br><br>'.PHP_EOL;
