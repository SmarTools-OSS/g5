...
<div id="st-mypage">
			...
			<form name="fnew" method="get" class="form-inline">		
				...
				<div class="input-group input-group-sm">
					...
					<span class="input-group-btn">
						<a href="<?=ST_MYPAGE_URL?>?mode=comment" class="btn btn-sm btn-default btn-reset" title="리셋"><i class="fa fa-repeat" aria-hidden="true"></i></a>
    ...
    <?php if ($i == 0)
        echo '<tr><td colspan="'.($is_admin? 6: 5).'" class="empty_table">댓글이 없습니다.</td></tr>';
    ?>
    </tbody>
    </table>	
